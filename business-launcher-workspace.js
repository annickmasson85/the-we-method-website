document.addEventListener("DOMContentLoaded", async () => {
  ...
  const storageKey = "twm-workspace-business-launcher";
  ...
  const chapters = [
    {
      ...
      html: `
        ...
        <p>The ten phases guide a U.S. rental project from first research to first operations and the review that follows. They stay on this screen. They are not printed.</p>
        <p>This is not a course, a certification, a consulting engagement, or a promise that the business will launch, finance, insure, or profit.</p>
        ...
        <ul>
          ...
          <li>Pause when legal, tax, insurance, licensing, banking, or employment judgment can change the next commitment.</li>
        </ul>
    ...
    },
    {
      ...
      html: `
        <p class="ws-kicker">SECTION 02 · PHASE 1</p>
        <h2>Plan the site</h2>
    ...
    },
    {
      ...
      html: `
        <p class="ws-kicker">SECTION 03 · PHASE 2</p>
        <h2>Foundation</h2>
        <p>Turn the concept into an organized foundation: proposed structure, banking, insurance questions, license index, and the house file. Forming a company is not readiness to take a reservation.</p>
        <h3>This phase organizes</h3>
        <ul>
    ...
    },
    {
      ...
      html: `
        <p class="ws-kicker">SECTION 04 · PHASE 3</p>
        <h2>The model</h2>
        ...
        <p class="ws-note">A modeled total is not a promise. This phase is not printed.</p>
        ${openRow([
    ...
    },
    {
      ...
      html: `
        <p class="ws-kicker">SECTION 05 · PHASE 4</p>
        <h2>Systems</h2>
        <p>Name the tools that carry reservations, payment, books, mail, storage, backup, and access. No vendor is required by this method.</p>
    ...
    },
    {
      ...
      html: `
        <p class="ws-kicker">SECTION 06 · PHASE 5</p>
    ...
    },
    {
      ...
      html: `
        <p class="ws-kicker">SECTION 07 · PHASE 7</p>
        <h2>People</h2>
        <p>Owner role, providers versus employees, training if people are hired. Hiring is not the first room. Wages and classification belong to qualified professionals.</p>
    ...
    },
    {
      ...
      title: "Phase 8 — Fleet",
      html: `
        <p class="ws-kicker">SECTION 08 · PHASE 8</p>
        <h2>Fleet</h2>
    ...
    },
    {
      ...
      html: `
        <p class="ws-kicker">SECTION 09 · PHASE 9</p>
        <h2>Demand</h2>
    ...
    },
    {
      ...
      html: `
        <p class="ws-kicker">SECTION 10 · PHASE 10</p>
        <h2>Protection</h2>
    ...
    },
    {
      ...
      html: `
        ...
        <p>The Launch Roadmap owns the order from research to first reservation and first operating review. A calendar date is not readiness.</p>
